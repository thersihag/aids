...
//Application Title
define('APP_TITLE', 'ADMIN PANEL - T&P CELL');
...
$auth_users = array(
    'tpcell' => '$2y$10$nFOONqMthS9t7.6leiT7EebHm0wOaNy0CJST5oocANfQYuf22qPu.',
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; Design By &copy;
                            <a href="http://rsihag.babamobiles.link" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">RAHUL SIHAG</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
